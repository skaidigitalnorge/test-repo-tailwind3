...
//   token:
//     "sk1jvvrBdMFaboFGyBIWdvzENM7E8vgKkDG60DJMZqsMacYzcsTtFaxpUYQZ0FHBG4cHO2ll7f77g7RfXHRe4ky5Z3ZrZj6mR4gA3UBQgjKsZsoLwLp54y08kbhLqN0FwJgTTJcHBKBzc7HRQuCibjar5pX2ZIUf3kYvVhnbzgshBizToYmw",
//   useCdn: false,
...
export default async function send(req, res) {
  console.log("Er i product-update");
  ...
  console.log("Fetch metafields for product");
  // Fetch the metafields for this product
  const shopifyProduct = await axios({
    url: `https://${process.env.SHOP}.myshopify.com/admin/products/${id}/metafields.json`,
    method: "GET",
  ...
  let stx = sanityClient.transaction();
  ...
  const currentVariants = await sanityClient.fetch(
